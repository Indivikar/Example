...
public class ExtendableNavigation extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		scene.getStylesheets().add(ExtendableNavigation.class.getResource("my.css").toExternalForm());
	...
	void initialize() {
		...
		setIcon(navButton1, "trash-icon.png");
		setIcon(navButton2, "Linux-icon.png");
		setIcon(navButton3, "Programs-Windows-icon.png");
		setIcon(navButton4, "Apple-icon.png");
//		mouseOver();
		hidePane();
