package addVonTabelleZuTabelle;
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (!isNoDataTableRow()) {
                    ...
                    if(upOrDown.equals("up")) {
                        ...
                        Image imageOk = new Image(getClass().getResourceAsStream("resources/32px-Gnome-go-up.svg.png"));
                        actionButton.setGraphic(new ImageView(imageOk));
                    } else {
                        actionButton= new Button("Remove!");
                        Image imageOk = new Image(getClass().getResourceAsStream("resources/32px-Gnome-go-down.svg.png"));
                        actionButton.setGraphic(new ImageView(imageOk));
                    }
