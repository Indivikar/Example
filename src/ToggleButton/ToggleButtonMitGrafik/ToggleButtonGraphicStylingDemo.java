package ToggleButton.ToggleButtonMitGrafik;
...
public class ToggleButtonGraphicStylingDemo extends Application {
	...
	private void configureScene(){
		...
		scene.getStylesheets().add(ToggleButtonGraphicStylingDemo.class.getResource("ToggleButtonGraphicStylingDemo.css").toExternalForm());
	}
