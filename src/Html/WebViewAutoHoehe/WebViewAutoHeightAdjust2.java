...
public class WebViewAutoHeightAdjust2 extends Application {
	public static final String JQUERY_URL = WebViewAutoHeightAdjust2.class.getResource("jquery-1.7.2.js").toExternalForm();
	public static final String MYJS_URL = WebViewAutoHeightAdjust2.class.getResource("myscript.js").toExternalForm();
	Stage stage;
	Scene scene;
	StackPane root;
	...
	private void configureScene(){
		...
		scene.getStylesheets().add(WebViewAutoHeightAdjust2.class.getResource("template.css").toExternalForm());
	}
