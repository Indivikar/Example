package ComboBox.ComboBoxFilter.model;
 ...
 */
public class FilterComboBox2<T extends Object> extends ComboBox<T>
{
    /**
     ...
     */
    public FilterComboBox2(final boolean startsWithCheck)
    {
        super();
     ...
     * @param startsWithCheck true if this is a 'startsWith' check false if it is 'contains' check
     */
    public FilterComboBox2(final ObservableList<T> items, final boolean startsWithCheck)
    {
        super(items);
        this.startsWithCheck = startsWithCheck;
        super.setEditable(true);
