...
public class TokenInputSearchFlowControl<ItemType> extends VBox {
	...
	private void configureSearchField() {
		HBox hb = new HBox();
		Image searchImg = new Image(getClass().getResourceAsStream("images/search.png"));
	...
	private class Cell extends Group {
		...
		private Cell(final ItemType item) {
			...
			deleteButton = new ImageView(new Image(getClass().getResourceAsStream("images/cross-script.png")));
			...
			ImageView arrow = new ImageView(new Image(getClass().getResourceAsStream("images/arrow.png")));
